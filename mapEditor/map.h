...
typedef struct _S_MAP_OBJECT{
	...
	void (*fpDrawTile_trn_mirror_v)(struct _S_MAP_OBJECT *,int,int,struct _S_MAP_OBJECT *);
	void (*fpDrawTile_trn_mirror_h)(struct _S_MAP_OBJECT *,int,int,struct _S_MAP_OBJECT *);
}_S_MAP_OBJECT;
